#Downloading pafy and prettytable

import os
os.system('pip install --upgrade youtube_dl pafy prettytable pyfiglet')
print('Everything is perfectly installed')
...
result = pyfiglet.figlet_format("Youtube Downloader") 
